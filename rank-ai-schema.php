...
final class Rank_AI_Schema {
    ...
    private function load_files() {
        ...
        require_once RAS_DIR . 'includes/class-ras-upgrader.php';
        require_once RAS_DIR . 'includes/class-ras-version-page.php';
    }
    ...
    public function menus() {
        ...
        add_submenu_page( 'rank-ai-schema', 'Version Control', 'Version Control',
            'manage_options', 'rank-ai-schema-version', [ 'RAS_Version_Page', 'render' ] );
    }
    ...
    public function assets( $hook ) {
        $pages = [
            ...
            'rank-ai-schema_page_rank-ai-schema-version',
...
add_action( 'plugins_loaded', function () {
    ...
    if ( class_exists( 'RAS_Upgrader' ) ) {
        RAS_Upgrader::maybe_upgrade();
    }
} );
